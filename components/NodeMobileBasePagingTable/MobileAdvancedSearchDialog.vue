    ...
    methods: {
        ...
        async handleConfirm(){
            try{
                ...
                var parameters = Object.assign(this.parameters, {page: this.page, pageSize: this.pageSize, sort: this.sort, sortOrder: this.sortOrder, advancedSearch:  searchFilterSet})

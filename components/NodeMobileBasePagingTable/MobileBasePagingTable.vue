<template>
  <v-container>
    ...
    <mobile-advanced-search-dialog :visible.sync="visible" :headers="headers" :parameters="parameters" :tableName="tableName" @confirm="handleAdvancedSearchConfirm" :page="1" :pageSize="this.pageSize" :sort="this.currentSortProp" :sortOrder="this.currentSortOrder"/>
  </v-container>
</template>
<script lang="js">
import Vue from "vue";
